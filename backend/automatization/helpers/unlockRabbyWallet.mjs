...
async function unlockRabbyWallet(browser) {
  const loginUrl = 'chrome-extension://acmacodkjbdgmoleebolmdjonilkdbch/index.html#/unlock';
...
export default unlockRabbyWallet;
